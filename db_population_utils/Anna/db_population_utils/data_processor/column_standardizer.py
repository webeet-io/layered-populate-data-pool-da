...
class ColumnStandardizer:
    """
    Standardizes column names (lowercase, remove special chars, collapse spaces to underscores)
    and ensures uniqueness by suffixing duplicates.

    Returns `(df_out, report)` and keeps a standardization history.
    Provides basic validation and recommendations for column names.
    """
