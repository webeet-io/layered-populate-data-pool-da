...
Usage Examples:
    # Initialize once
    db = SmartDBConnector("postgresql://user:pass@host:5432/db")
...
class SmartDBConnector:
    """
    Smart Database Connector - Everything automated in one call.
    ...
    def close(self):
        """Clean shutdown."""
        self.engine.dispose()
        self.logger.info("SmartDBConnector closed")
