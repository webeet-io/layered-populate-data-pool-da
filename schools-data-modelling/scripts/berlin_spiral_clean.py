...
def main():
    ...
    try:
        ...
        # 💾 
        schools_with_siz.to_file("schools_with_spiral_zones.geojson", driver="GeoJSON")
        schools_with_siz.to_csv("schools_with_spiral_zones.csv", index=False)
        print("✅ Spiralzonen wurden den Schulen zugewiesen und gespeichert!")
